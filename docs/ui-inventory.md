...
Generated by `node scripts/generate-ui-inventory.mjs` at 2026-08-17T14:59:34.916Z.
...
- Total UI TSX files: 223
- By kind: `component` 141, `story` 19, `modal` 17, `ui` 2, `page` 31, `route-component` 13
- By area: `app` 78, `chat` 15, `common` 26, `input` 12, `knowledge-base` 5, `layout` 7, `message-parts` 2, `model-selector` 5, `session` 3, `settings` 27, `modal` 17, `copilots` 9, `dev` 7, `image-creator` 10
- By platform signal: `all` 192, `desktop` 14, `mobile` 18, `web` 3
...
- Variants: `color:chatbox-brand`, `default`, `filled`, `light`, `size:md`, `size:xs`
- Text: `About`, `about-introduction`, `about-slogan`, `Already up to date`, `Changelog`, `Check Update`, `Checking...`, `Download from official site`, `Downloading...`, `E-mail`, `Feedback`, `Github`, `New version available`, `Official Site`, `QR Code`, `Restart & Update`, `Retry`, `Update failed`
...
- States: `active`, `checked`, `forceShowNewUserScenarioCards`
- Variants: `color:blue`, `light`, `size:lg`, `size:sm`, `size:xs`
- Text: `Complete generated catalog of UI pages, components, states, text, and preview links`, `Component Previews`, `Context Generator`, `CSS Variables Preview`, `Dev Tools`, `Development Mode`, `Force the New Chat page to show onboarding scenario cards.`, `FORCE_ENABLE_DEV_PAGES`, `Generate fake conversation context for testing context management and token estimation`, `How to Add New Previews`, `Inspect key-value and blob storage entries provided by the unified platform layer`, `Inspect local libsql state for session attachment RAG`, `No component previews available yet`, `Open Preview`, `Runtime Controls`, `Session RAG Inspector`, `Storage Explorer`, `These dev tools are hidden in production builds unless`, `UI Inventory`
...
- States: `disabled`, `error`, `hasNextPage`, `isCurrentlyGenerating`, `isExceeded`, `isExceededResolved`, `isFetchingNextPage`, `isLoading`, `isRetrying`, `isSmallScreen`, `isTempUpload`, `prompt`, `referenceImages`, `selected`, `selectedModel`, `selectedProvider`, `selectedRatio`, `showHistory`, `showMobileHistory`, `showModelDrawer`, `showRatioDrawer`
- Variants: `color:gray`, `color:white`, `filled`, `light`, `size:compact-md`, `size:md`, `size:sm`, `size:xs`, `subtle`
- Text: `AI-generated images may not be accurate. Review output carefully.`, `Describe the image you want to create...`, `History`, `Image Creator`, `New Creation`, `No models available`, `Please select a model`, `Resume Generation`, `Upload`
...
- States: `error`, `forceShowNewUserScenarioCards`, `hasCompletedFirstSuccessfulChat`, `isExceeded`, `isExceededResolved`, `isSmallScreen`, `selected`, `session`
...
- States: `error`, `isExceeded`, `isExceededResolved`, `isFetching`, `isSmallScreen`
- Variants: `outline`
...
- States: `active`, `checked`, `disabled`, `editingPresetId`, `error`, `exportItems`, `exportNotice`, `exportResult`, `hasPartialFailure`, `importDetails`, `importRequiresRestart`, `importTips`, `isColorAllowed`, `isCreatingInterfaceColorPreset`, `isCustom`, `isEditingInterfaceColorPresets`, `isExporting`, `isImporting`, `isInterfaceBrandColorAllowed`, `isLoading`, `isRecovering`, `isZipBackupFile`, `loading`, `pendingDownload`
- Variants: `color:chatbox-gray`, `color:red`, `color:yellow`, `filled`, `light`, `outline`, `primary`, `size:sm`, `size:xs`, `subtle`
- Text: `{{count}} conversations could not be recovered due to data read errors`, `{{count}} item(s) could not be included. See manifest.json in the backup for details.`, `{{phase}}: {{current}} / {{total}}`, `API KEY & License`, `Automatic updates`, `Backup exported successfully`, `Backup exported with warnings`, `Backup files exported here can only be imported in Chatbox 1.22 or later.`, `Backup ready to download`, `Backup restore is almost complete, with {{count}} warning(s). Select Continue to restart Chatbox and finish restoring.`, `Beta updates`, `Brand Color`, `Cancel`, `Chat History`, `Clear Logs`, `Color Presets`, `Continue`, `Conversation data could not be read and was not included.`, `Creating backup archive`, `Dark Mode`, `Data Backup`, `Data Recovery`, `Data Restore`, `Delete`, `Diagnostic Logs`, `Display Settings`, `Download`, `Edit`, `Export application logs for troubleshooting. These logs may be requested by support to help diagnose issues.`, `Export canceled`, `Export failed`, `Export Logs`, `Export Selected Data`, `Exporting attachments`, `Exporting conversations`, `Exporting...`, `Follow System`, `Font Size`, `General Settings`, `Home Page`, `If conversations are missing from the list, use this feature to scan and recover them from storage`, `Import and Restore`, `Import canceled`, `Import failed: {{error}}`, `Importing...`, `Last Session`, `Launch at system startup`, `Light Mode`, `Managed attachment or image data could not be read and was not included.`, `My Copilots`, `Name`, `Network Proxy`, `New Preset`, `Preparing backup`, `Primary Background`, `Reading backup`, `Recover Conversation List`, `Recovered {{count}} conversations`, `Recovering...`, `Recovery failed`, `Reset Colors`, `Restoring data`, `Save`, `Save Preset`, `Secondary Background`, `Settings`, `socks5://127.0.0.1:6153`, `Startup Page`, `Tertiary Background`, `The attachment search index could not be restored.`, `The conversation list has been successfully recovered`, `The original external file is not managed by Chatbox and was not included.`, `Theme`, `This browser does not support streaming downloads, so the backup was buffered before saving.`, `Unknown error`, `Unsupported or damaged backup`, `Upon import, changes will take effect immediately and existing data will be overwritten`, `Validating backup`, `ZIP backups include each conversation and its managed images and attachments.`
...
- Variants: `color:chatbox-secondary`, `subtle`
- Text: `About`, `Settings`
...
- Text: `API key invalid!`, `Bing Search is provided for free use, but it may have limitations and is subject to change by Microsoft.`, `BoCha API Key`, `Check`, `Connection successful!`, `Enter your Querit API Key`, `Get API Key`, `Max Results`, `Maximum number of results to return.`, `Provided tools`, `Querit API Key`, `Querit Search Options`, `Read Webpage`, `Search Provider`, `Tavily API Key`, `Time Range`, `Time range of the search. For example, the last month.`, `Web Search`
...
- States: `disabled`, `isFullscreen`, `isSmallScreen`, `opened`, `reloadSign`, `visible`
- Variants: `color:chatbox-tertiary`, `size:100%`, `size:md`, `size:xs`, `subtle`, `transparent`
- Text: `Close`, `Exit fullscreen`, `Fullscreen`, `Open in Browser`, `Open in Browser requires a preview URL`, `Preview`, `Refresh`
...
- Metadata: kind: `modal`; area: `modal`
- Components: `ChatConfig`, `PictureConfig`, `SessionSettingsModal`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
...
- Text: `Background Image`, `Background Settings`, `Conversation Settings`, `Copilot Prompt Demo`, `Instruction (System Prompt)`, `Max Output Tokens`, `Modify the creativity of AI responses; the higher the value, the more random and intriguing the answers become, while a lower value ensures greater stability and reliability.`, `Name`, `Not set`, `Number of Images per Reply`, `Pause after every {{count}} steps`, `Reset`, `Save`, `Set the maximum number of tokens for model output. Please set it within the acceptable range of the model, otherwise errors may occur.`, `Specific model settings`, `Stream output`, `Support jpg or png file smaller than 5MB`, `Support jpg or png file smaller than 5MB. Overrides global background when set.`, `Temperature`, `The topP parameter controls the diversity of AI responses: lower values make the output more focused and predictable, while higher values allow for more varied and creative replies.`, `Top P`, `Upload`

### modals/Settings

- Source: `src/renderer/modals/Settings.tsx`
- Metadata: kind: `modal`; area: `modal`
- Components: `RootRoute`, `SettingsArchiveRoute`, `SettingsChatRoute`, `SettingsDefaultModelsRoute`, `SettingsDocumentParserRoute`, `SettingsGeneralRoute`, `SettingsHotkeysRoute`, `SettingsIndexRoute`, `SettingsKnowledgeBaseRoute`, `SettingsMcpRoute`, `SettingsProviderIndexRoute`, `SettingsProviderProviderIdRoute`, `SettingsProviderRouteRoute`, `SettingsSkillsRoute`, `SettingsWebSearchRoute`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
...
- Source: `src/renderer/components/AppProviders.tsx`
- Metadata: kind: `component`; area: `app`
- Components: `AppProviders`
- Platform signals: `all`
- Platform notes: None detected
...
### components/chat/ForkGroup

- Source: `src/renderer/components/chat/ForkGroup.tsx`
- Metadata: kind: `component`; area: `chat`
- Components: `ForkGroup`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: Missing real fixture
- States: `active`, `disabled`, `expanded`, `flash`, `isForkMarker`, `isSmallScreen`, `isSummary`, `revealedBranchIds`
- Variants: `color:chatbox-brand`, `size:compact-xs`, `size:xs`, `subtle`
- Text: `{{count}} follow-up messages`, `1 follow-up message`, `Collapse other branches`, `delete`, `Expand view`, `Next reply`, `Previous reply`, `Reply {{index}}`, `Showing {{shown}} of {{total}} other replies`, `Switch to this branch`, `Wait for compaction to finish`, `Wait for the current replies to finish`
...
### components/chat/ImageGenerationResultGallery

- Source: `src/renderer/components/chat/ImageGenerationResultGallery.tsx`
- Metadata: kind: `component`; area: `chat`
- Components: `ImageGenerationResultGallery`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
...
- Metadata: kind: `component`; area: `chat`
- Components: `CollapseButton`, `MessageActionIcon`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
...
- States: `actionMenuOpened`, `collapsed`, `disabled`, `error`, `hasFoldableProcess`, `isBubbleLayout`, `isCancellableGeneratingAssistantMessage`, `isClassicLayout`, `isClassicMessage`, `isCollapsed`, `isErrorReminder`, `isMessageReminderPresentation`, `isRetryableToolCallStep`, `isRightAlignedMessage`, `isSmallScreen`, `isStreamingMode`, `isThisYear`, `isToday`, `isUserBubble`, `opened`, `processCollapsed`, `retryChoiceOpened`, `success`
- Variants: `color:chatbox-brand`, `color:chatbox-secondary`, `color:gray`, `light`, `size:11px`, `size:sm`, `size:xs`, `subtle`
- Text: `{{count}} steps`, `characters`, `Click to view full text`, `Collapse`, `Continue in Chat Mode`, `copied to clipboard`, `copy`, `Copy`, `delete`, `Edit`, `Expand`, `First token latency`, `Generate More Images Below`, `Image generated`, `Image generation failed`, `Message Raw JSON`, `Model`, `More`, `OCR Text`, `OCR Text Content`, `Quote`, `Reply Again`, `Reply Again Below`, `report`, `Retry failed response`, `Retry from last step`, `Retry whole message`, `Stop generating this reply`, `The response failed after the last step. What would you like to retry?`, `Total tokens consumed`, `Use Work Mode`, `View Message JSON`, `Wait for the current replies to finish`, `Waited {{time}}`, `Word count`, `Work Mode suggested`, `Worked for {{time}}`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Auth Error (401)](http://localhost:6006/?path=/story/real-components-messageerrtips--auth-error-401), [Storybook: Context Length Error](http://localhost:6006/?path=/story/real-components-messageerrtips--context-length-error), [Storybook: Chatbox AI OCR Free Daily Quota Exhausted — Reminder Card](http://localhost:6006/?path=/story/real-components-messageerrtips--chatbox-ai-ocr-free-daily-quota-exhausted-reminder-card), [Storybook: Free Daily Quota Exhausted — Reminder Card](http://localhost:6006/?path=/story/real-components-messageerrtips--free-daily-quota-exhausted-reminder-card), [Storybook: Generic Error](http://localhost:6006/?path=/story/real-components-messageerrtips--generic-error), [Storybook: Generic Error — Bubble Layout](http://localhost:6006/?path=/story/real-components-messageerrtips--generic-error-bubble-layout), [Storybook: Long Error with Response Body](http://localhost:6006/?path=/story/real-components-messageerrtips--long-error-with-response-body), [Storybook: Multiple Error Types Comparison](http://localhost:6006/?path=/story/real-components-messageerrtips--multiple-error-types-comparison), [Storybook: Network Error (fetch failed)](http://localhost:6006/?path=/story/real-components-messageerrtips--network-error-fetch-failed), [Storybook: Chatbox AI OCR Quota Exhausted — Reminder Card](http://localhost:6006/?path=/story/real-components-messageerrtips--chatbox-ai-ocr-quota-exhausted-reminder-card), [Storybook: Quota Exhausted — Reminder Card](http://localhost:6006/?path=/story/real-components-messageerrtips--quota-exhausted-reminder-card), [Storybook: Rate Limit Error (429)](http://localhost:6006/?path=/story/real-components-messageerrtips--rate-limit-error-429), [Storybook: Server Error (500)](http://localhost:6006/?path=/story/real-components-messageerrtips--server-error-500), [Storybook: Error Without Retry Button](http://localhost:6006/?path=/story/real-components-messageerrtips--error-without-retry-button)
...
- States: `active`, `atBottom`, `atTop`, `isFirstItem`, `isFollowing`, `isForkMarker`, `isLastItem`, `isLatestSummary`, `isNewMessage`, `isSmallScreen`, `isSummary`, `isUserNavigationMessage`, `messageNavigationVisible`, `messageViewportHeight`, `showScrollToPrev`, `visible`
- Variants: `size:xs`, `transparent`
- Text: `Back to previous message`, `Continue this thread`, `delete`, `Edit Thread Name`, `Move to Conversations`, `New Thread`, `Return to the top`, `Show in Thread List`, `Wait for the current replies to finish`
...
- States: None detected
- Variants: `color:var(--chatbox-tint-brand)`, `size:xs`
- Text: `{{count}} lines`, `Advanced Mode`, `Loading webpage...`, `Local Mode`, `Reading file...`, `Retrying {{attempt}}/{{maxAttempts}}`

### components/chat/MessageMinimapRail

- Source: `src/renderer/components/chat/MessageMinimapRail.tsx`
- Metadata: kind: `component`; area: `chat`
- Components: `BASE_LINE_WIDTH`, `DEFAULT_VIEWPORT_HEIGHT`, `HOVER_DISTANCE`, `HOVER_FALLOFF_POWER`, `ITEM_HEIGHT`, `MAX_LINE_WIDTH`, `MessageMinimapRail`, `PREVIEW_MARGIN`, `WINDOW_OVERSCAN_ITEMS`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
- States: `hasScrollableOverflow`, `hasScrolledToInitialEndRef`, `hoveredAnchor`, `keyboardAnchorIndex`, `pointerContentY`, `scrollHeight`, `scrollTop`, `viewportHeight`, `visible`
- Variants: None detected
- Text: `Attachment message`, `Jump to message {{index}}`
...
### components/chat/PendingApprovalPill

- Source: `src/renderer/components/chat/PendingApprovalPill.tsx`
- Metadata: kind: `component`; area: `chat`
- Components: `PendingApprovalPill`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Approval card + floating pill](http://localhost:6006/?path=/story/real-components-pendingapprovalpill--approval-card-floating-pill)
- States: `error`, `isSmallScreen`
- Variants: `color:chatbox-brand`, `color:chatbox-error`, `light`, `size:compact-sm`, `size:sm`, `size:xs`
- Text: `{{count}} operation(s) awaiting approval`, `Approve`, `Deny`, `View`

### components/chat/PictureGallery

- Source: `src/renderer/components/chat/PictureGallery.tsx`
- Metadata: kind: `component`; area: `chat`
- Components: `ImageInStorageGalleryItem`, `PictureGallery`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: Missing real fixture
...
### components/chat/QuotaExhaustedCard

- Source: `src/renderer/components/chat/QuotaExhaustedCard.tsx`
- Metadata: kind: `component`; area: `chat`
- Components: `QuotaExhaustedCard`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
- States: `isFreeQuota`, `isOcrQuota`
- Variants: `light`, `size:13px`, `size:sm`, `size:xs`
- Text: `Chatbox AI OCR points are used up`, `OCR model settings`, `The current model uses Chatbox AI OCR to process images, and its quota for the current period is used up. Upgrade your plan or change the default OCR model to continue.`, `Your points are used up`, `Your quota for the current period is used up. Upgrade your plan to continue.`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Chatbox welcome card setup provider state](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-welcome-card-setup-provider-state)
- States: None detected
- Variants: `filled`, `size:xs`
- Text: `Select and configure an AI model provider`, `Setup Provider`, `Welcome to Chatbox!`
...
- States: `error`
- Variants: None detected
- Text: `Error:`, `Reload App`, `Something went wrong!`, `Stack:`, `The application encountered an unexpected error.`, `Try Again`

### components/common/InterfaceColorInput

- Source: `src/renderer/components/common/InterfaceColorInput.tsx`
- Metadata: kind: `component`; area: `common`
- Components: `InterfaceColorInput`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
- States: `draftValue`, `isColorAllowed`
- Variants: None detected
- Text: None detected
...
- Preview modes: None detected
- Preview links: [Storybook: Image display count style and model select states](http://localhost:6006/?path=/story/real-components-app-base--image-display-count-style-and-model-select-states)
- States: `isCustom`, `isValidElement`
- Variants: `size:sm`, `size:xs`
...
- Source: `src/renderer/components/ImageViewer.tsx`
- Metadata: kind: `component`; area: `app`
- Components: `DOWNLOAD_ICON`, `ImageViewer`, `REPORT_ICON`
- Platform signals: `mobile`
- Platform notes: `checks platform.type === mobile`
- Preview modes: None detected
- Preview links: Missing real fixture
- States: `isButton`, `isCustomSVG`
- Variants: None detected
- Text: `custom-download-button`, `Download`, `Promise`, `report`, `report-button`
...
- Components: `CLOSE_DELAY`, `CompactAgentModeIcon`, `OPEN_DELAY`, `WEB_SEARCH_MOVED_TIP_DISMISSED_KEY`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
...
- States: `disabled`, `isWebSearchMovedTipDismissed`, `opened`, `showWebSearchMovedTip`, `visible`
- Variants: `size:sm`, `size:xs`, `subtle`
- Text: `Chat Mode`, `Close`, `This model is older and has limited capabilities, so it does not support more advanced features.`, `Web Search has moved`, `Web Search is now available in the mode menu.`, `Work Mode`
...
- States: `active`, `checked`, `disabled`, `error`, `expanded`, `isActive`, `isChatModeSelected`, `isDisabled`, `isLockedDisabled`, `isModelDisabled`, `isNewSession`, `isProviderAvailable`, `isSelected`, `isSmartSwitchingDisabled`, `page`, `skills`, `skillsLoading`, `skillsVersion`, `subPanelAlign`, `subPanelTop`, `visible`
...
- Text: `Add Folder`, `Add Skills`, `Add your first MCP server`, `Approve`, `Ask before running commands or changing files.`, `Best for multi-step tasks with files, code execution, tools, MCP, skills, or knowledge bases.`, `Best for quick Q&A, writing, translation, explanations, and web search.`, `Built-in`, `Chat Mode`, `Code Execution`, `Configure in Settings`, `Create`, `Extensions`, `Full Access`, `Grant the agent read/write access to local folders without per-action approval.`, `Knowledge Base`, `Locked after the chat starts to keep tools and context consistent — start a new chat to change`, `MCP`, `Mode`, `Only available before the first message.`, `Recent`, `Remove`, `Skills`, `Skip approval prompts for commands and file changes.`, `Smart Switching`, `Suggest Work Mode on the first message.`, `This model does not support Agent Mode`, `Web Search`, `Work Mode`, `Working Directory`

### components/InputBox/AgentModeStatusIcon

- Source: `src/renderer/components/InputBox/AgentModeStatusIcon.tsx`
- Metadata: kind: `component`; area: `input`
- Components: `AgentModeStatusIcon`, `StatusIcon`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Attachment mini card image file processing completed error states](http://localhost:6006/?path=/story/real-components-input-surfaces--attachment-mini-card-image-file-processing-completed-error-states), [Storybook: Attachment parser type label local mineru inline and indexed](http://localhost:6006/?path=/story/real-components-input-surfaces--attachment-parser-type-label-local-mineru-inline-and-indexed), [Storybook: Message attachment inline retrieval indexed indexing blocked failed states](http://localhost:6006/?path=/story/real-components-input-surfaces--message-attachment-inline-retrieval-indexed-indexing-blocked-failed-states)
...
- Text: `Cannot index`, `chunks`, `Click to view parsed content`, `Content`, `File Content`, `Finishing`, `Indexed`, `Indexed · {{count}} chunks`, `Indexing`, `Indexing failed`, `Large file indexing failed. Remove this file and try uploading it again. If the problem continues, use a smaller file or Knowledge Base.`, `Large file Q&A requires a model with tool use support. Switch to a compatible model or remove this file.`, `Link Content`, `No points consumed`, `Parser: {{parser}}`, `Parser: Local`, `Preparing`, `Processing failed`, `Queued`, `Status`, `Still indexing`, `Switch model`, `This attachment is too large for chat attachments. Please upload it through Knowledge Base instead.`, `This document contains too much text for chat attachments. Please upload it through Knowledge Base instead.`, `This large file cannot be indexed here. Upload it through Knowledge Base, or use a smaller file.`, `Too large`, `Too much text`, `Unavailable`
...
- Metadata: kind: `component`; area: `input`
- Components: `InputBox`, `MAX_ATTACHMENTS`, `MAX_IMAGES`
- Platform signals: `desktop`, `mobile`
...
- States: `active`, `disabled`, `error`, `hasBlockedSessionRagFiles`, `hasContent`, `hasErrorFiles`, `hasLargeAttachmentWarning`, `hasPreprocessErrors`, `hasProcessingFiles`, `hasSessionRetrievalFiles`, `hasText`, `hasTextContent`, `inputSkills`, `inputSkillsLoading`, `isActive`, `isAgentModeActive`, `isAutoCompactionEnabled`, `isAwaitingToolApproval`, `isCalculating`, `isCompacting`, `isCompactionInProgress`, `isCompactionRunning`, `isDeepSeekWeakToolUse`, `isDuplicate`
- Variants: `default`, `filled`, `light`, `size:sm`, `size:xs`
- Text: `{{count}} document(s) are still being prepared. If you send now, the answer may not use the full document.`, `Advanced image formats are not supported. Please convert to JPG or PNG.`, `An error occurred while sending the message.`, `Archive files are not supported. Please extract and upload individual files.`, `Attach Image`, `Audio files are not supported`, `Binary/executable files are not supported`, `Chat attachments must be {{limit}} or smaller.`, `Conversation Settings`, `Document is still indexing`, `File Content`, `Finishing`, `Go to Image Creator`, `Indexed`, `Indexing`, `iWork files (Pages, Keynote) are not supported. Please export to PDF or Office format.`, `New Thread`, `Preparing`, `Queued`, `Rollback Thread`, `Select File`, `Select Model`, `Send anyway`, `Still indexing`, `Stop`, `Stop all {{n}} replies`, `This attachment is very large and may consume more points. You can send it anyway, or remove it and use a smaller file.`, `This image session is no longer active. Please use the new Image Creator for image generation.`, `This model does not support Agent Mode`, `This model may not be able to read the uploaded document. Try another model if you want to ask about the file.`, `Type your question here...`, `Unsupported file type: {{fileName}}`, `Video files are not supported`, `Wait`, `Waiting for approval`, `Web Search`, `You can attach up to {{limit}} files. The extra files were skipped.`, `You can attach up to {{limit}} images. The extra images were skipped.`

### components/InputBox/MessageInputField

- Source: `src/renderer/components/InputBox/MessageInputField.tsx`
- Metadata: kind: `component`; area: `input`
...
- Preview modes: None detected
- Preview links: Missing real fixture
- States: `isNewSession`, `isReadOnly`
- Variants: `size:sm`
- Text: None detected
...
- Metadata: kind: `component`; area: `input`
- Components: `CompactReasoningLevelIcon`, `ReasoningControlButton`, `ReasoningLevelStatusIcon`, `StatusIcon`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Knowledge base chunks preview modal](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-chunks-preview-modal)
...
- States: `deleteConfirmKb`, `disabled`, `editKb`, `editRerankModel`, `editVisionModel`, `error`, `hasModel`, `isConfirmDisabled`, `isEmbedding`, `isEmbeddingDisabled`, `isProviderAvailable`, `isUnsupportedPlatform`, `isWin32Arm64`, `kbList`, `newDocumentParser`, `newEmbeddingModel`, `newKbName`, `newRerankModel`, `newVisionModel`, `opened`, `showCreate`
- Variants: `color:orange`, `color:red`, `color:var(--chatbox-tint-tertiary)`, `default`, `light`, `outline`, `size:lg`, `size:sm`, `size:xs`, `subtle`
- Text: `Add`, `Are you sure you want to delete the knowledge base`, `Cancel`, `Create`, `Create First Knowledge Base`, `Create Knowledge Base`, `Create your first knowledge base to start adding documents and enhance your AI conversations with contextual information.`, `Delete`, `Delete Knowledge Base`, `Edit`, `Edit Knowledge Base`, `Embedding`, `Failed to create knowledge base, Error: {{error}}`, `Failed to fetch knowledge base list, Error: {{error}}`, `Failed to update knowledge base, Error: {{error}}`, `Knowledge Base`, `Knowledge Base functionality is not available on Windows ARM64 due to library compatibility issues. This feature is supported on Windows x64, macOS, and Linux.`, `Local`, `Name`, `No Knowledge Base Yet`, `None`, `Parser`, `Platform Not Supported`, `Provider unavailable`, `Rerank`, `Save`, `This action cannot be undone. All documents and their embeddings will be permanently deleted.`, `Unknown`, `Vision`
...
- States: `disabled`, `error`, `expanded`, `hasProcessingFiles`, `hasValidExtension`, `hasValidMimeType`, `hasVisionModel`, `isDragOver`, `isExpanded`, `isFetchingNextPage`, `isLoading`, `isLocalParser`, `isNaN`, `isOpen`, `isParsedContentTooLarge`, `isRemoteParser`, `isThisYear`, `isToday`, `loading`, `opened`, `showScrollIndicator`, `showUploadArea`, `sizeRejectedFiles`, `success`
- Variants: `color:blue`, `color:green`, `color:orange`, `color:red`, `color:var(--chatbox-tint-brand)`, `color:var(--chatbox-tint-gray)`, `color:var(--chatbox-tint-placeholder)`, `color:var(--chatbox-tint-primary)`, `color:var(--chatbox-tint-success)`, `color:var(--chatbox-tint-warning)`, `light`, `size:lg`, `size:sm`, `size:xs`, `subtle`
- Text: `{{count}} file(s) exceed the {{limit}} knowledge base upload limit.`, `{{count}} file(s) not supported: {{files}}. Supported formats: {{formats}}`, `Add File`, `And {{count}} more file(s).`, `chunks`, `Delete`, `Documents`, `Done`, `Drag and drop files here, or click to browse`, `Drop files here`, `Failed to open file dialog: {{error}}`, `Failed to upload {{filename}}: {{error}}`, `Knowledge Base documents must be {{limit}} or smaller.`, `Local parse failed`, `Maximum file size`, `MinerU parse failed`, `No documents yet`, `No files were dropped`, `Parsed document content must be {{limit}} or smaller.`, `Pause`, `Processing failed`, `Resume`, `Retry locally`, `Some files were not uploaded`, `Successfully uploaded {{count}} file(s)`, `Successfully uploaded {{success}} of {{total}} file(s). {{failed}} file(s) failed.`, `Supported formats`, `Too much text`, `Upload failed: {{error}}`, `Upload your first document to get started`
...
- States: `connectionResult`, `disabled`, `error`, `isConfirmDisabled`, `isEmbeddingDisabled`, `loading`, `mineruToken`, `success`, `testingConnection`
- Variants: `color:green`, `color:red`, `default`, `outline`, `size:xs`
- Text: `Cancel`, `Connected`, `Connection failed`, `Connection successful`, `Delete`, `Document Parser`, `Embedding Model`, `Enter your MinerU API token`, `Failed`, `New knowledge base name`, `Parser used to process uploaded documents`, `Please enter an API token`, `Rerank Model (optional)`, `Test Connection`, `Third-party cloud parsing service, supports PDF and most Office files. Requires API token.`, `Used to extract text feature vectors, add in Settings - Provider - Model List`, `Used to get more accurate search results`, `Used to preprocess image files, requires models with vision capabilities enabled`, `Uses built-in document parsing feature, supports common file types.`, `Vision Model (optional)`
...
- Components: `ANDROID_APK_URL`, `DesktopDownloadReminder`, `DISMISS_KEY`, `IOS_APP_STORE_URL`
...
- States: `dismissed`, `isSmallScreen`
...
- States: `isSmallScreen`
- Variants: `color:chatbox-tertiary`, `subtle`
...
- Text: `Clear All Messages`, `copied to clipboard`, `Copy Conversation ID`, `Delete Current Session`, `Duplicate Conversation`, `Export Chat`, `Full Width`, `Search`, `Session Raw JSON`, `Standard Width`, `Thread History`, `View Session JSON`
...
- Metadata: kind: `component`; area: `app`
- Components: `BlockCode`, `BlockCodeCollapsedStateContext`, `CODE_BLOCK_COLLAPSE_LINE_THRESHOLD`, `CodeRenderer`, `InlineCode`, `Markdown`, `MarkdownImage`, `ShikiCodeBlock`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Markdown mermaid SVG and artifact preview states](http://localhost:6006/?path=/story/real-components-app-base--markdown-mermaid-svg-and-artifact-preview-states)
- States: `asyncHtml`, `collapsed`, `collapsedStates`, `isCollapsed`, `isFinite`, `isRenderableCode`, `isRenderableCodeLanguage`, `naturalSize`, `success`
- Variants: `color:chatbox-tertiary`, `color:var(--chatbox-tint-tertiary)`, `transparent`
- Text: `Collapse`, `copy`, `Expand`, `Preview`
...
- States: `checked`, `disabled`, `opened`
...
- Metadata: kind: `component`; area: `app`
- Components: `Loading`, `MermaidRenderError`, `MermaidSVGPreviewDangerous`, `MessageMermaid`, `SVGPreview`
- Platform signals: `mobile`
- Platform notes: `checks platform.type === mobile`
- Preview modes: None detected
- Preview links: [Storybook: Markdown mermaid SVG and artifact preview states](http://localhost:6006/?path=/story/real-components-app-base--markdown-mermaid-svg-and-artifact-preview-states)
- States: `error`, `isButton`, `isCustomSVG`, `isFinite`, `loading`, `renderError`, `svgCode`, `svgId`
- Variants: None detected
- Text: `copied to clipboard`, `custom-rotate-button`, `Loading...`

### components/message-parts/SandboxFileLink

- Source: `src/renderer/components/message-parts/SandboxFileLink.tsx`
- Metadata: kind: `component`; area: `message-parts`
- Components: `SAVE_DIALOG_CANCELLED`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
- States: `disabled`, `error`, `exportError`, `state`, `success`
- Variants: `color:var(--chatbox-tint-brand)`, `idle`, `saving`, `unavailable`
- Text: `Export failed`, `File no longer available`

### components/message-parts/ToolCallPartUI

- Source: `src/renderer/components/message-parts/ToolCallPartUI.tsx`
- Metadata: kind: `component`; area: `message-parts`
- Components: `APPROVAL_ACTION_BUTTON_PROPS`, `APPROVAL_PAYLOAD_MAX_HEIGHT`, `GIT_BASH_DOWNLOAD_URL`, `HTML_EXTENSIONS`, `Icon`, `IMAGE_EXTENSIONS`, `TIMELINE_NODE_CENTER`, `TIMELINE_NODE_SIZE`, `TIMELINE_NODE_TOP`, `TIMELINE_STACK_GAP`, `TOOL_ERROR_PREVIEW_LENGTH`, `TOOL_PAYLOAD_PREVIEW_LENGTH`, `WSL_INSTALL_URL`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Approval card + floating pill](http://localhost:6006/?path=/story/real-components-pendingapprovalpill--approval-card-floating-pill), [Storybook: Actively Thinking](http://localhost:6006/?path=/story/real-components-reasoningcontentui--actively-thinking), [Storybook: Completed — No Streaming Mode (no timer)](http://localhost:6006/?path=/story/real-components-reasoningcontentui--completed-no-streaming-mode-no-timer), [Storybook: Completed — With Reasoning Content](http://localhost:6006/?path=/story/real-components-reasoningcontentui--completed-with-reasoning-content), [Storybook: Completed — With Duration Timer](http://localhost:6006/?path=/story/real-components-reasoningcontentui--completed-with-duration-timer), [Storybook: Completed — Empty Content](http://localhost:6006/?path=/story/real-components-reasoningcontentui--completed-empty-content), [Storybook: Code Execution — Bash Not Available](http://localhost:6006/?path=/story/real-components-toolcallpartui--code-execution-bash-not-available), [Storybook: Code Search — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--code-search-success), [Storybook: Knowledge Base — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--knowledge-base-loading), [Storybook: Multiple Tool Calls](http://localhost:6006/?path=/story/real-components-toolcallpartui--multiple-tool-calls), [Storybook: Parse Link — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--parse-link-loading), [Storybook: Read File — Bash Not Available](http://localhost:6006/?path=/story/real-components-toolcallpartui--read-file-bash-not-available), [Storybook: Read File — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--read-file-success), [Storybook: Step Timeline — Paused at Step Limit](http://localhost:6006/?path=/story/real-components-toolcallpartui--step-timeline-paused-at-step-limit), [Storybook: Step Timeline — Reasoning + Tools](http://localhost:6006/?path=/story/real-components-toolcallpartui--step-timeline-reasoning-tools), [Storybook: Step Timeline — Running](http://localhost:6006/?path=/story/real-components-toolcallpartui--step-timeline-running), [Storybook: Step Timeline — Interleaved Text](http://localhost:6006/?path=/story/real-components-toolcallpartui--step-timeline-interleaved-text), [Storybook: Terminal — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--terminal-success), [Storybook: Web Search — Error](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-error), [Storybook: Web Search — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-loading), [Storybook: Web Search — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-success)
- States: `active`, `collapsed`, `disabled`, `error`, `expanded`, `hasActiveStatus`, `hasDetail`, `hasError`, `hasFinished`, `hasLoading`, `isApproval`, `isApprovalPaused`, `isApprovalPauseReason`, `isArray`, `isBackgroundActive`, `isBackgroundInterrupted`, `isBackgroundUnrecoverable`, `isBackgroundWaiting`, `isBashNotAvailable`, `isBashNotAvailableResult`, `isBlockedByOtherGeneration`, `isCancelled`, `isCommandExecutionPart`, `isCommandFailure`
- Variants: `color:chatbox-brand`, `color:chatbox-error`, `color:gray`, `color:var(--chatbox-tertiary)`, `color:var(--chatbox-tint-brand)`, `color:var(--chatbox-tint-error)`, `color:var(--chatbox-tint-success)`, `color:var(--chatbox-tint-warning)`, `color:yellow`, `light`, `size:10px`, `size:compact-xs`, `size:sm`, `size:xs`, `subtle`
- Text: `{{count}} results`, `Another image is being generated. Please wait.`, `Approval required before executing this command.`, `Approval required before modifying files.`, `Approve`, `Approve and generate`, `Arguments`, `Artifacts`, `Aspect ratio`, `Bash is not available on this Windows device.`, `Cancel`, `Checking every {{time}}`, `Command`, `Completed`, `Continue`, `Copy reasoning content`, `Deeply thought`, `Denied`, `Deny`, `Download Git Bash`, `Error`, `Explanation failed`, `Failed`, `Failed to update the setting. Please try again.`, `File no longer available`, `Generate images`, `Generating image`, `How to install WSL2`, `Image generated`, `Image generation failed`, `Image generation interrupted`, `Image style`, `Install Git Bash or enable WSL to run Bash code. You can continue using Node.js code execution without either.`, `More continue options`, `Number of images`, `Paused`, `Paused after {{count}} steps. Check whether the task is on track, then continue or stop to adjust.`, `Preparing file...`, `Preview`, `Preview not available`, `Prompt`, `Result`, `Resume Generation`, `Running`, `Save`, `Search unsuccessful`, `Stop`, `Stopped`, `The original task cannot be resumed. Please send a new image generation request.`, `Thinking`, `This chat is no longer available.`, `This request may incur charges from {{provider}}.`, `Thought for {{time}}`, `Tool call failed`, `Tool execution is paused.`, `Unable to resume image generation.`, `Waiting to resume image generation`
...
- Text: `Capabilities`, `Close`, `Compute point exchange`, `Condition`, `Input`, `Official API price`, `Otherwise`, `Output`, `Pricing`, `Tiered pricing`
...
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: Missing real fixture
- States: `activeTab`, `desktopDetail`, `hasRightSideSpace`, `isCustom`, `isFavorited`, `isFavoritedModel`, `isMobile`, `isValidElement`, `mobileDetail`, `mobileOpen`, `search`, `visible`
- Variants: `size:sm`, `size:xs`, `unstyled`
- Text: `All`, `Auto`, `Favorite`, `Model details`, `No eligible models available`, `No favorite models`, `Search models`, `Select Model`
...
- Platform notes: `checks platform.type === mobile`, `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Session item selected generating completed and picture states](http://localhost:6006/?path=/story/real-components-session--session-item-selected-generating-completed-and-picture-states)
- States: `actionTooltipDismissed`, `archiving`, `disabled`, `error`, `isReordering`, `isSame`, `isSmallScreen`, `loading`, `longPressing`, `mobileMenuOpened`, `opened`, `selected`
- Variants: `color:chatbox-tertiary`, `size:sm`, `transparent`
- Text: `Adjust order`, `Archive`, `Archived. Manage archived chats in Settings.`, `Clean up`, `Completed`, `Generating...`, `Manage`, `Pin`, `Too many archived chats`, `Unpin`, `You have archived more than {{count}} chats. Do you want to clean them up now?`
...
- Platform signals: `web`
- Platform notes: `checks platform.type === web`, `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
...
- States: `active`, `activeDragId`, `disabled`, `hasNextPage`, `isDragging`, `isFetchingNextPage`, `isReordering`, `isSmallScreen`, `selected`
- Variants: `size:compact-sm`, `size:sm`, `size:xs`, `subtle`
- Text: `Adjust order`, `Chats`, `Done`, `Pinned`
...
- Platform signals: `all`
- Platform notes: `branches when platform.type is not mobile`, `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
...
- States: `active`, `isImporting`, `isSmallScreen`, `opened`, `query`
- Variants: `filled`, `size:md`, `size:sm`, `size:xs`
...
- States: `debouncedSearchQuery`, `error`, `hasMore`, `hasNextPage`, `installing`, `isFetchingNextPage`, `isInstalled`, `isLoading`, `isSearchLoading`, `isSkillEntryInstalled`, `loading`, `opened`, `searchQuery`, `success`, `translatedPopular`, `translatedSearch`
...
### components/StreamingTextFade

- Source: `src/renderer/components/StreamingTextFade.tsx`
- Metadata: kind: `component`; area: `app`
- Components: `StreamingTextFade`
- Platform signals: `all`
- Platform notes: None detected
...
- Metadata: kind: `component`; area: `app`
- Components: `Dialog`, `DialogClose`, `DialogContent`, `DialogDescription`, `DialogFooter`, `DialogHeader`, `DialogOverlay`, `DialogPortal`, `DialogTitle`, `DialogTrigger`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Command palette primitives and dialog primitives states](http://localhost:6006/?path=/story/real-components-app-base--command-palette-primitives-and-dialog-primitives-states)
...
- Metadata: kind: `component`; area: `app`
- Components: `AppTooltip`, `Tooltip`, `TooltipContent`, `TooltipProvider`, `TooltipTrigger`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
- States: `disabled`, `error`, `isValidElement`, `opened`
- Variants: None detected
- Text: None detected
...
- Text: `Created on {{date}}`, `Delete`, `Edit`, `Pin`, `Published on {{date}}`, `Unpin`
...
- Components: `AvatarSample`, `SeedToasts`, `SurfaceLabel`, `ThrowOnRender`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Avatar user assistant system chat picture states](http://localhost:6006/?path=/story/real-components-common-feedback--avatar-user-assistant-system-chat-picture-states), [Storybook: Chatbox AI error message quota license file and web browsing states](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-ai-error-message-quota-license-file-and-web-browsing-states), [Storybook: Chatbox welcome card setup provider state](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-welcome-card-setup-provider-state), [Storybook: Compression modal opened confirmation state](http://localhost:6006/?path=/story/real-components-common-feedback--compression-modal-opened-confirmation-state), [Storybook: Error boundary fallback and retry states](http://localhost:6006/?path=/story/real-components-common-feedback--error-boundary-fallback-and-retry-states), [Storybook: Divider link mark scalable icon and segmented control states](http://localhost:6006/?path=/story/real-components-common-feedback--divider-link-mark-scalable-icon-and-segmented-control-states), [Storybook: Toast stack top-right feedback states](http://localhost:6006/?path=/story/real-components-common-feedback--toast-stack-top-right-feedback-states)
- States: `error`, `opened`, `segment`, `success`
- Variants: `size:lg`, `size:sm`, `size:xs`
- Text: `Actual conversation compression confirmation modal used before forced context compaction.`, `Actual error boundary with the default app fallback, retry, reload, and details states.`, `Actual global toast renderer backed by the shared UI store.`, `Actual localized Chatbox AI service error copy with settings, plan, homepage, and parser action links.`, `Actual user, assistant, system, chat, and picture avatar variants used in session and message rows.`, `Actual utility components used throughout settings, message content, and toolbar controls.`, `Assistant`, `Avatar`, `Avatar user assistant system chat picture states`, `Chat icon`, `Chatbox AI error message quota license file and web browsing states`, `Chatbox homepage link`, `Chatbox welcome card setup provider state`, `ChatboxAIErrorMessage`, `ChatboxWelcomeCard`, `Compression modal opened confirmation state`, `CompressionModal`, `Divider link mark scalable icon and segmented control states`, `Error boundary fallback and retry states`, `ErrorBoundary`, `Inline common utilities`, `Long support conversation`, `Open compression modal`, `Picture`, `Setup prompt shown on empty chat and image creator when no provider is configured.`, `System`, `Toast stack top-right feedback states`, `Toast store is populated; notifications render in the production Snackbar stack.`, `Toasts`, `User`, `Vertical divider`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Knowledge base documents upload ready processing paused failed states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-documents-upload-ready-processing-paused-failed-states), [Storybook: Knowledge base form provider parser model and action states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-form-provider-parser-model-and-action-states), [Storybook: Knowledge base menu selected and create states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-menu-selected-and-create-states), [Storybook: Knowledge base chunks preview modal](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-chunks-preview-modal), [Storybook: Knowledge base page list documents and provider states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-page-list-documents-and-provider-states)
- States: `embeddingModel`, `error`, `isKnowledgeBaseEnvironmentSeeded`, `name`, `opened`, `parserConfig`, `rerankModel`, `selected`, `success`, `visionModel`
- Variants: `light`, `size:sm`, `size:xs`
- Text: `Actual composer knowledge base selector menu with selected state and settings/create entry points.`, `Actual documents section with upload affordance, completed file, processing progress, paused file, local parse failure, server parse failure, retry, pause, resume, delete, and chunks preview entry points.`, `Actual form controls used for create/edit knowledge base flows, including parser selection, model selectors, read-only parser display, and destructive edit actions.`, `Actual knowledge base modal for inspecting parsed chunks.`, `Actual knowledge base settings page with configured bases, provider pills, parser pills, edit actions, and embedded document lists.`, `ChunksPreviewModal`, `Empty knowledge base`, `Empty onboarding docs`, `Empty state uses the same menu after the query returns no knowledge bases.`, `Knowledge Base`, `Knowledge base chunks preview modal`, `Knowledge base documents upload ready processing paused failed states`, `Knowledge base form provider parser model and action states`, `Knowledge base menu selected and create states`, `Knowledge base page list documents and provider states`, `Knowledge Base: Product launch`, `KnowledgeBase`, `KnowledgeBaseDocuments`, `KnowledgeBaseForm`, `KnowledgeBaseMenu`, `Name`, `Product launch knowledge base`, `Support handbook`, `The production modal is mounted open in this preview.`
...
- Metadata: kind: `story`; area: `app`; stories: `AuthError`, `ContextLengthError`, `FreeOcrQuotaExhaustedReminder`, `FreeQuotaExhaustedReminder`, `GenericError`, `GenericErrorBubbleLayout`, `LongErrorWithResponseBody`, `MultipleErrors`, `NetworkError`, `OcrQuotaExhaustedReminder`, `QuotaExhaustedReminder`, `RateLimitError`, `ServerError`, `WithoutRetry`
...
### components/stories/PendingApprovalPill.stories

- Source: `src/renderer/components/stories/PendingApprovalPill.stories.tsx`
- Metadata: kind: `story`; area: `app`; stories: `ApprovalCardWithFloatingPill`
- Components: `PendingApprovalPill.stories`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Approval card + floating pill](http://localhost:6006/?path=/story/real-components-pendingapprovalpill--approval-card-floating-pill)
- States: None detected
- Variants: `size:sm`
- Text: `Approval card + floating pill`, `Approval pill story`
...
- Metadata: kind: `story`; area: `app`; stories: `AddProviderModalStates`, `CustomMcpServersStates`, `DocumentParserSettingsStates`, `GitHubInstallModalStates`, `ImportProviderModalStates`, `McpConfigModalStates`, `McpRegistrySpotlightStates`, `ProviderIconStates`, `ProviderListStates`, `ProviderSpotlightStates`, `SkillsSectionStates`, `SkillsSpotlightStates`
